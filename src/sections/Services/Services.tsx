...
export const Services = () => {
  ...
  return (
    <section
      id="section_2"
      className="h-[851px] tab:h-[621px] desk:h-[779px] relative"
    >
      ...
      >
        {data.servicesData.map((el, ind) => (
          <SwiperSlide
            key={ind}
            className={`slider_common slider_${
              ind + 1
            } text-text-white pt-[134px] tab:pt-[64px]  desk:pt-[104px]`}
          >
            <Container>
              <p className="text-text-white font-thin text-xxxl_mob_date tab:text-xxxl_tab_date desk:text-xxl_desk text-right desk:pr-[368px]">
                0{ind + 1}/<span className="text-text-date">05</span>
              </p>
              <div className="tab:grid tab:grid-cols-[463px_1fr] tab:gap-5 tab:mt-9 tab:h-[375px] desk:grid-cols-[607px_1fr] desk:gap-[332px] ">
                ...
                <div
                  className={`tab:mt-[197px] desk:mt-0 tab:flex tab:flex-col tab:justify-between slogan-${ind} `}
                >
                  <p className="text-right tab:text-left text-xs_slogan font-extralight mt-3 tab:mt-0 ">
                    {el.slogan}
                  </p>
                  <p className="text-sm tab:text-xs_13 text-justify font-extralight   mt-[224px] tab:mt-0 tab:block">
                    {el.text}
                  </p>
                </div>
              </div>
